...
namespace EightQueensGA
{
    ...
    class GeneticAlgo
    {
        ...
        public void DoMating(ref List<Chromosome> initPopulation, int generations, double probCrossver, double probMutation)
        {
            ...
            {                
                PrepareRouletteWheel(ref initPopulation,totalFitness);
        ...
        public void Crossover(ref List<Chromosome> parents, double probability)
        {
            ...
            {                
                ...
                {
                    Chromosome parentX = AssayRouletteWheel(parents);
                    Chromosome parentY = AssayRouletteWheel(parents);
        ...
        private void PrepareRouletteWheel(ref List<Chromosome> parents,int total)
        {
        ...
        private Chromosome AssayRouletteWheel(List<Chromosome> parents)
        {
